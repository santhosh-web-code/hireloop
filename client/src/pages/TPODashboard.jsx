        ...
        <aside className="tpo-sidebar">
          <button
            ...
            style={{
              ...
              padding: '12px 16px',
              borderRadius: '8px',
              background: activeTab === 'analytics' ? 'var(--bg-active-tab)' : 'transparent',
              color: activeTab === 'analytics' ? 'var(--text-active-tab)' : 'var(--text-primary)',
              border: 'none',
              cursor: 'pointer',
              fontWeight: '600',
              textAlign: 'left',
          ...
          <button
            ...
            style={{
              ...
              padding: '12px 16px',
              borderRadius: '8px',
              background: activeTab === 'overview' ? 'var(--bg-active-tab)' : 'transparent',
              color: activeTab === 'overview' ? 'var(--text-active-tab)' : 'var(--text-primary)',
              border: 'none',
              cursor: 'pointer',
              fontWeight: '600',
              textAlign: 'left',
          ...
          <button
            ...
            style={{
              ...
              padding: '12px 16px',
              borderRadius: '8px',
              background: activeTab === 'pendingHRs' ? 'var(--bg-active-tab)' : 'transparent',
              color: activeTab === 'pendingHRs' ? 'var(--text-active-tab)' : 'var(--text-primary)',
              border: 'none',
              cursor: 'pointer',
              fontWeight: '600',
              textAlign: 'left',
          ...
          <button
            ...
            style={{
              ...
              padding: '12px 16px',
              borderRadius: '8px',
              background: activeTab === 'pendingJDs' ? 'var(--bg-active-tab)' : 'transparent',
              color: activeTab === 'pendingJDs' ? 'var(--text-active-tab)' : 'var(--text-primary)',
              border: 'none',
              cursor: 'pointer',
              fontWeight: '600',
              textAlign: 'left',
          ...
          <button
            ...
            style={{
              ...
              padding: '12px 16px',
              borderRadius: '8px',
              background: activeTab === 'students' ? 'var(--bg-active-tab)' : 'transparent',
              color: activeTab === 'students' ? 'var(--text-active-tab)' : 'var(--text-primary)',
              border: 'none',
              cursor: 'pointer',
              fontWeight: '600',
              textAlign: 'left',
          ...
          <button
            ...
            style={{
              ...
              padding: '12px 16px',
              borderRadius: '8px',
              background: activeTab === 'notifications-center' ? 'var(--bg-active-tab)' : 'transparent',
              color: activeTab === 'notifications-center' ? 'var(--text-active-tab)' : 'var(--text-primary)',
              border: 'none',
              cursor: 'pointer',
              fontWeight: '600',
              textAlign: 'left',
